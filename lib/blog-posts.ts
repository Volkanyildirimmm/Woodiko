...
export const BLOG_POSTS: Record<string, BlogPostData> = {
  'ankara-mutfak-dolabi-fiyatlari-2024': {
    ...
    excerpt:
      'Ankara\'da mutfak dolabı yaptırmayı düşünüyorsunuz ama fiyatlar hakkında hiçbir fikriniz yok mu? Malzeme, m² ve aksesuar bazında güncel fiyat tablosu.',
    ...
    related: ['kucuk-mutfaklar-icin-dolap-onerileri', 'akrilik-lake-mdf-mutfak-karsilastirma', 'siteler-mobilyasi-kalite-rehberi'],
    keywords: ['ankara mutfak dolabı fiyatları', 'mutfak dolabı m2 fiyat', 'siteler mutfak dolabı'],
    content: `
...
Woodiko olarak şeffaf fiyatlandırma politikamızla Ankara'da güvenilir bir tercih olmaya devam ediyoruz.
  ...
  'kucuk-mutfaklar-icin-dolap-onerileri': {
    ...
    excerpt:
      'Dar veya küçük bir mutfağınız var ama maksimum depolama alanına ihtiyaç duyuyorsunuz? İşte ustalardan 10 pratik öneri.',
    ...
    related: ['ankara-mutfak-dolabi-fiyatlari-2024', 'akrilik-lake-mdf-mutfak-karsilastirma'],
    keywords: ['küçük mutfak dolabı', 'dar mutfak çözümleri', 'stüdyo daire mutfak'],
    content: `
...
Bazı kapılarda ayna veya cam kullanmak mekânı görsel olarak büyütür.
  ...
  'cayyolu-yasamkent-umitkoy-ozel-mobilya-rehberi': {
    title: 'Çayyolu, Yaşamkent ve Ümitköy\'de Özel Mobilya: Bölgeye Özel Rehber (2026)',
    excerpt:
      'Çayyolu, Yaşamkent ve Ümitköy\'de oturanların özel mobilya yaptırırken bilmesi gerekenler. Apartman tipleri, ortalama m², bölgesel fiyat farkı ve montaj gerçekleri.',
    ...
    authorImage: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&h=100&q=80&fit=crop',
    related: ['ankara-mutfak-dolabi-fiyatlari-2024', 'siteler-mobilyasi-kalite-rehberi', 'akrilik-lake-mdf-mutfak-karsilastirma'],
    keywords: [
      'çayyolu mutfak dolabı',
      'yaşamkent özel mobilya',
      'ümitköy gardırop',
      'çayyolu mobilya firması',
      'ankara batı yakası mobilya',
    ],
    content: `
## Ankara'nın Batı Hattı: Neden Farklı Bir Yaklaşım Gerekiyor?

Çayyolu, Yaşamkent, Ümitköy ve Bağlıca; Ankara'nın batı hattındaki en yoğun yerleşim bölgeleri. Bu bölgelerde mobilya yaptıran müşterilerimiz genelde benzer beklentiler taşıyor: modern tasarım, kaliteli malzeme, kısa teslim süresi. Ancak bölgenin kendine has bazı pratik gerçekleri var ki bunlar projeyi planlarken farkındalık gerektirir.

### Apartman Tipi ve Asansör Faktörü

Çayyolu ve Yaşamkent'teki sitelerin büyük kısmı 2005 sonrası yapı. Bu da şu anlamlara geliyor:

- **Asansör boyutları:** Çoğu sitede asansör 110×140 cm civarında. Tek parça ada mutfak adası, yatak başlığı veya 240+ cm gardırop kapağı asansöre sığmayabilir. Modüler montaj mantığı şart.
- **Site yönetim izni:** Hafta içi mesai saatleri dışında montaj yasağı var. Cumartesi 09:00–17:00 arası en uygun zaman dilimi.
- **Yük asansörü ayrımı:** Bazı sitelerde malzeme yalnızca yük asansörü ile çıkarılabiliyor; rezervasyon önceden alınmalı.

### Bölgesel Daire Tipleri ve Ortalama Mutfak Boyutu

| Bölge | Tipik Daire Tipi | Ortalama Mutfak m² |
|-------|------------------|---------------------|
| Çayyolu | 3+1, 4+1 | 12–18 m² |
| Yaşamkent | 2+1, 3+1 | 10–14 m² |
| Ümitköy | 3+1, 4+1, 5+1 | 14–22 m² |
| Bağlıca | 2+1, 3+1 | 9–13 m² |

Bu rakamlar planlama için kritik. Yaşamkent'te 2+1 bir dairede tek tezgâhlı L-mutfak yeterliyken, Ümitköy'deki 4+1 dairelerde ada mutfak veya G-tipi planlama daha uygun.

### Bölgesel Fiyat Farkı Var mı?

Doğrudan fiyat farkı yoktur — malzeme ve işçilik aynıdır. Ancak şu üç kalem batı yakasında farklılaşır:

1. **Nakliye:** Siteler atölyemizden Ümitköy'e mesafe yaklaşık 25–30 km. Tek seferlik nakliye 1.500–2.500₺.
2. **Montaj süresi:** Site içi park, asansör rezervasyonu gibi nedenlerle Çankaya/Kızılay'a göre yarım gün uzayabilir.
3. **Bahçe katı/dubleks:** Ümitköy ve Bağlıca'da yaygın olan dubleks dairelerde merdiven boşluğu için özel ölçüm + dar uçlu modülasyon gerekiyor — bu, m² fiyatına %5–8 ek getirebiliyor.

### Bölgeye Özel Tasarım Trendleri

Çayyolu/Yaşamkent müşterilerinde son 12 ayda öne çıkan tercihler:

- **Mat siyah + ceviz kombinasyonu:** Mutfaklarda klasik beyazın yerini almaya başladı.
- **Gizli kulp (handleless):** Lake kapaklarda %70 üzeri tercih oranı.
- **Walk-in closet:** Ümitköy'de 4+1 dairelerin tipik talebi haline geldi.
- **Banyo-mutfak malzeme uyumu:** Akrilik kapaklı mutfak yaptıran müşterilerin %40'ı banyoyu da aynı tonla istiyor.

### Çayyolu Mutfak Dolabı: Ortalama Bütçe

Çayyolu'nda 12 m² standart bir mutfak için 2026 bütçeleri:

- **Ekonomik (E1 MDF + yerli aksesuar):** 80.000–120.000₺
- **Orta segment (lake + Hettich):** 130.000–200.000₺
- **Premium (akrilik + Blum + ada):** 220.000–380.000₺

### Ümitköy Gardırop: Walk-in Closet Maliyeti

Ümitköy'deki tipik 4+1 dairelerde 6–8 m² walk-in closet için 2026 bütçesi:

- **Açılır kapı + raf sistemi:** 90.000–140.000₺
- **Sürgülü cam kapaklı premium sistem:** 160.000–260.000₺
- **LED + yumuşak kapanma çekmece + ada (premium):** 280.000–450.000₺

### Yaşamkent Özel Mobilya: 2+1 Kombinasyonları

Yaşamkent'teki 2+1 dairelerde bütçe optimizasyonu için en sık önerdiğimiz paket:

1. L-mutfak (10 m²) — orta segment lake
2. Yatak odası gardırop (4 m taban) — sürgülü, aynalı
3. TV ünitesi (3 m duvar) — duvar paneli + kitaplık entegre

Bu üçlü paket için ortalama 220.000–320.000₺ bütçe yeterli oluyor.

### Bölge İçin Pratik Tavsiyeler

- **Keşif öncesi:** Site yönetiminden montaj saat aralığını mutlaka öğrenin.
- **Ölçüm günü:** Tüm odaları boş olarak gösterin; halı, yatak gibi ölçü hatasına neden olabilen eşyalar kaldırılmalı.
- **Renk kararı:** Yaşamkent ve Çayyolu'nun yoğun gün ışığı alan dairelerinde mat yüzeyler parlak yüzeylere göre daha avantajlı; yansıma ve parmak izi sorunu azalır.
- **Teslim süresi:** Bölgeye özel proje yoğunluğu nedeniyle Mayıs–Eylül arası 5–7 hafta, kış aylarında 4–5 hafta beklemek gerekiyor.

### Woodiko'nun Bölgeye Yaklaşımı

Siteler atölyemizden Çayyolu, Yaşamkent, Ümitköy ve Bağlıca'ya **ücretsiz keşif** sunuyoruz. Ölçüm sonrası 3 boyutlu görsel + şeffaf fiyat teklifi 48 saat içinde size ulaşıyor. Yaşamkent ve Çayyolu'nda son 12 ayda 70+ proje tamamladık — bölgenin apartman dinamiklerini iyi biliyoruz.
    `,
  },

  'akrilik-lake-mdf-mutfak-karsilastirma': {
    title: 'Akrilik mi, Lake mi, MDF mi? Mutfak Dolabı Malzeme Karşılaştırması (2026)',
    excerpt:
      'Mutfak dolabı yaptıracaksınız ama hangi malzemeyi seçeceğinize karar veremiyor musunuz? Akrilik, lake, membran ve doğal ahşap kaplamanın tüm farkları.',
    ...
    author: 'Volkan Yıldırım',
    authorImage: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&h=100&q=80&fit=crop',
    related: ['ankara-mutfak-dolabi-fiyatlari-2024', 'cayyolu-yasamkent-umitkoy-ozel-mobilya-rehberi', 'siteler-mobilyasi-kalite-rehberi'],
    keywords: [
      'akrilik mı lake mi',
      'mdf mi sunta mı',
      'mutfak dolabı malzeme karşılaştırma',
      'lake kapak ankara',
      'akrilik kapak fiyat',
      'membran kapak yorumları',
    ],
    content: `
## Mutfak Dolabı Kapak Malzemesi: Doğru Karar Nasıl Verilir?

Yeni bir mutfak yaptıracaklara en sık sorduğumuz soru şu: "Kapağın görüntüsü mü, dayanıklılığı mı, fiyatı mı sizin için en önemli?" Çünkü bu üç beklentiyi tek bir malzemede birleştirmek mümkün değil — her seçim bir tercih demek. Aşağıda en yaygın 5 kapak tipini gerçek atölye deneyimine göre kıyasladık.

### 1. Akrilik Kapak

Yüksek parlak yüzeyiyle modern mutfakların yıldızı.

**Artıları:**
- Cam gibi parlak görüntü, derin renk doygunluğu
- UV dayanımı yüksek; renk solmaz
- 0,4–1 mm akrilik tabaka kazınmaya karşı korumalı

**Eksileri:**
- Parmak izi sorunu (özellikle siyahta belirgin)
- Kenar bantlama hatasına çok hassas — kötü işçilikte 6 ay sonra kabarma görülür
- Lake'e göre %15–25 daha pahalı

**Kim için ideal?** Az kullanılan, "showroom" görüntüsü isteyen mutfaklar. Yoğun pişirme yapan aileler için ilk tercih değil.

### 2. Lake (Boyalı MDF)

Ankara'da son 5 yılın en çok satan kapak tipi.

**Artıları:**
- Mat, yarı-mat, parlak — her finiş mevcut
- Renk seçeneği sınırsız (RAL paleti)
- Ufak çiziklerde lokal rötuş yapılabilir
- Akrilikten %15–25 daha ekonomik

**Eksileri:**
- Yüzey, akriliğe göre kazınmaya daha hassas
- Yüksek nemde kenarda zamanla nüans farkı oluşabilir
- Kalite, boya kat sayısına bağlı — 5 kat altı işçilik kabul etmeyin

**Kim için ideal?** Kişiselleştirme isteyen, RAL kodu seçmek isteyen, mat finish tutkunu kullanıcılar.

### 3. Membran (PVC kaplı MDF)

En ekonomik segment.

**Artıları:**
- Düşük maliyet (lake'in yarısı)
- Tek parça PVC örtü; kenar bantsız, su sızdırmaz görünür
- Ahşap deseni geniş seçenek

**Eksileri:**
- Isıdan etkilenir; ocak/fırın yakını kapaklarda 3–5 yıl sonra kabarma riski
- Yüksek parlak versiyonlarda görsel "plastik" hissi
- Yenilenmesi zor; çizik kalıcıdır

**Kim için ideal?** Kiralık daireler, yatırım amaçlı mutfaklar, kısa vadeli (5 yıl altı) kullanım planlayanlar.

### 4. Doğal Ahşap Kaplama

Premium segmentin değişmeyen tercihi.

**Artıları:**
- Doğal damar; her parça benzersiz
- Yaşlandıkça karakter kazanır
- Yenilenebilir (zımpara + verniklenebilir)

**Eksileri:**
- Akriliğin 1,5–2 katı maliyet
- Nem ve ısıya hassas; ada mutfakta tezgâh çevresine önerilmez
- Bakım gerekir; her 3–5 yılda yağlama/cila

**Kim için ideal?** Klasik veya country tarz yaşam, ahşaba duygusal bağ, premium bütçe (300.000₺+).

### 5. Alüminyum Profil + Cam

Modern, "loft" estetiği isteyen müşterilerin tercihi.

**Artıları:**
- Yangına dayanıklı, deformasyon yapmaz
- Cam panel ile içerideki ışıklı raflar görünür
- 20+ yıl ömür

**Eksileri:**
- Sıcak hissi vermez; salon-mutfak entegre planlarda soğuk durabilir
- Camda parmak izi
- Standart kapaklara göre %30 pahalı

**Kim için ideal?** Bar dolapları, vitrin amaçlı kullanım, modern dubleks giriş katı.

### Karşılaştırma Tablosu

| Kriter | Akrilik | Lake | Membran | Ahşap Kaplama | Alüminyum+Cam |
|--------|---------|------|---------|---------------|----------------|
| m² Fiyat (₺) | 10.000–18.000 | 8.000–15.000 | 4.500–8.000 | 12.000–25.000 | 11.000–17.000 |
| Dayanıklılık (1–5) | 4 | 4 | 2 | 5 | 5 |
| Bakım Kolaylığı | 3 | 4 | 5 | 2 | 3 |
| Görsel İmpakt | 5 | 4 | 3 | 5 | 5 |
| Yenilenebilirlik | 1 | 3 | 1 | 5 | 4 |
| Beklenen Ömür | 12–15 yıl | 12–18 yıl | 5–8 yıl | 25+ yıl | 25+ yıl |

### MDF mi, Sunta mı? Gövde Tarafı

Kapak tartışmasının yanında gövde malzemesi de kritik. Yaygın yanılgı: "MDF her zaman daha kaliteli." Gerçek daha nüanslı:

- **E1 sınıfı sunta gövde:** Standart mutfaklarda yeterli; %90 üreticinin tercihi. Daha hafif, daha ekonomik.
- **E1 sınıfı MDF gövde:** Suya uzun süre maruz kalabilecek bölümlerde (lavabo altı, bulaşık makinesi yanı) avantajlı.
- **Su geçirmez (yeşil) MDF:** Yalnızca banyo dolabında zorunlu. Mutfakta gereksiz maliyet.

**Püf nokta:** "Tüm gövde MDF" pazarlaması Ankara'da çok yaygın ama gerçek fark, aksesuarda (menteşe-ray) gizli. Blum/Hettich menteşesi olan E1 sunta gövde, Çinli menteşeli MDF gövdeden uzun ömürlüdür.

### Hangi Bütçeye Hangi Kombinasyon?

- **80.000–130.000₺** → Membran kapak + sunta gövde + yerli aksesuar
- **130.000–200.000₺** → Lake mat kapak + sunta gövde + Hettich aksesuar
- **200.000–300.000₺** → Akrilik veya lake premium kapak + sunta gövde + Blum
- **300.000₺+** → Doğal ahşap kaplama + Blum + iç aydınlatma + özel aksesuar

### Sonuç

Tek bir "doğru" malzeme yok. Bizim Ankara'daki müşteri kompozisyonumuzda dağılım şöyle:
...
Karar veremiyorsanız: kendi mutfağınızda 1 hafta boyunca pişirme alışkanlığınızı gözlemleyin. Çok yağlı yemek + sık silmek = mat lake. Vitrin görüntüsü + az kullanım = akrilik. Yatırım dairesi = membran. Her durumda, ücretsiz keşif randevumuzda örnek paneller getiriyor, evinizin ışığında karşılaştırma fırsatı sunuyoruz.
    `,
  },

  'siteler-mobilyasi-kalite-rehberi': {
    title: 'Siteler Mobilyası Hâlâ Kaliteli mi? Ankaralılar İçin Şeffaf Bir Rehber',
    excerpt:
      'Siteler mobilya merkezi olarak adını korusa da kalite algısı tartışmalı. 40+ yıllık atölye deneyimimizle Siteler\'in bugünkü gerçeğini anlatıyoruz.',
    ...
    author: 'Volkan Yıldırım',
    authorImage: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&h=100&q=80&fit=crop',
    related: ['ankara-mutfak-dolabi-fiyatlari-2024', 'akrilik-lake-mdf-mutfak-karsilastirma', 'cayyolu-yasamkent-umitkoy-ozel-mobilya-rehberi'],
    keywords: [
      'siteler mobilya kalitesi',
      'siteler ankara mobilya',
      'siteler mobilya tavsiye',
      'ankara siteler mutfak dolabı',
      'siteler güvenilir firma',
    ],
    content: `
## Siteler: Türkiye'nin Mobilya Hafızası

Ankara Siteler, 1960'lardan beri Türkiye'nin en büyük mobilya üretim ve satış merkezlerinden biri. Bizim atölyemiz Yıldırım Mobilya da 1982'den bu yana Şenyüz Sokak'ta üretim yapıyor. Yani Siteler hakkında konuşurken üçüncü el değil, içeriden konuşuyoruz.

Son yıllarda müşterilerimizden sıkça duyduğumuz soru şu: "Siteler artık eskisi gibi değil, doğru mu?" Bu yazıda bu soruyu dürüstçe yanıtlayacağız.

### Algı vs. Gerçek

**Yaygın algı:** "Siteler eskisi kadar kaliteli değil; ucuz iş çıkıyor."

**Gerçek:** Siteler bir bölge; tek bir üretici değil. Bölgede 5.000+ atölye/firma var. Bu ölçek, kalite skalasının çok geniş olmasına neden oluyor. Aynı sokakta, premium akrilik mutfak üreten bir atölyenin yanında, tabela yazılı ama montaj yapmayan bir aracı şirket de bulabilirsiniz.

Yani sorun "Siteler kalite kaybetti" değil; sorun **müşteriye doğru üreticiyi seçtirmenin zorlaşması**. 40 yıl önce bölgede 200 üretici varken, bugün 5.000 işletme var ve bunların büyük kısmı **üretici değil aracı**.

### Siteler'de Karşılaşacağınız 4 Tip İşletme

1. **Gerçek üretici (atölye sahibi):** Kendi makinası, kendi ustası, kendi malzemesi var. Genellikle 30+ yıllık aile işletmeleri. Şeffaflık yüksek; isterseniz atölyeyi gezdirir.
2. **Marka bayisi:** Belli markaların galerisi gibi çalışır. Üretim başka yerde, montaj kendi ekibi. Kalite markaya bağlı, fiyat genelde yüksek.
3. **Aracı firma (komisyoncu):** Siparişi alır, başka atölyeye yaptırır, üzerine pay koyar. En riskli grup; sorun çıktığında sorumluluk havada kalır.
4. **Showroom + dropshipping:** Sergideki mobilyalar başka şehirlerden geliyor. Özel üretim talep ettiğinizde dış kaynak kullanıyorlar.

### Doğru Üreticiyi Seçmenin 7 Pratik Yolu

1. **Atölyeyi görmek isteyin.** Üretici "buyurun gezelim" diyorsa güvenilirliğin %50'si tamam. Bahane uyduruyorsa muhtemelen üretici değil aracı.
2. **Makina parkı sorgulayın.** CNC, kenar bantlama, yatık delik makinesi — bunların hepsi varsa atölyedir.
3. **Garanti yazılı mı?** "10 yıl garanti" sözlü teklifte 0 değer. Sözleşmede madde olarak geçmeli.
4. **Aksesuar markası belirtilsin.** "Avrupa menteşesi" yetersiz; Blum/Hettich/Häfele gibi spesifik marka istemelisiniz.
5. **Daha önce yaptıkları işin telefonunu isteyin.** Müşteri referansı veremiyorsa şüphelenin.
6. **Kapora oranı.** Sağlıklı bir oran %30. %50+ kapora isteyen firma genelde nakit akış sorunu yaşıyordur.
7. **Sözleşmede teslim tarihi + gecikme bedeli olsun.** "Yaklaşık 5 hafta" değil; "27 Mayıs 2026" gibi net bir tarih ve gecikmesi durumunda günlük tazminat maddesi.

### 2026'da Siteler Fiyat Tablosu (Üretici, aracı değil)

| Ürün | Ekonomik | Orta | Premium |
|------|----------|------|---------|
| Mutfak (10 m²) | 80.000₺ | 150.000₺ | 280.000₺ |
| Yatak odası takımı | 60.000₺ | 110.000₺ | 220.000₺ |
| Gardırop (4 m) | 35.000₺ | 65.000₺ | 130.000₺ |
| Banyo dolabı | 18.000₺ | 32.000₺ | 60.000₺ |
| TV ünitesi (3 m) | 22.000₺ | 40.000₺ | 75.000₺ |

**Aracı firmadan aldığınızda** üzerine %15–35 pay biner. Yani aynı kalitedeki bir 150.000₺'lik mutfak, aracıdan 195.000–202.500₺ olur. Üretici doğrudan iş yaptığında kazanan müşteridir.

### Yıldırım Mobilya'nın Yaklaşımı

Biz 1982'den beri Şenyüz Sokak'taki atölyemizde üretim yapıyoruz. Showroom, kataloglar, tabelalar değişti — atölye aynı yerde, aynı ailede. Bu yazıyı yazma sebebimiz Siteler'in adını yıkamak değil; tam tersine, Siteler'in **doğru tarafını bulmanıza yardımcı olmak**.

Bir karar vermeden önce ücretsiz keşfimizi alın, atölyemizi gezin, malzemeleri görün, soru sorun. Sonra istediğinizle karşılaştırın. İyi bir üretici karşılaştırılmaktan çekinmez.

### Sıkça Sorulanlar

**Siteler'den mobilya alınır mı?**
Evet, ama doğrudan üreticiden. Aracı firmadan kaçınmak için yukarıdaki 7 maddeyi uygulayın.

**Siteler mi, IKEA mı, mağazadan hazır mobilya mı?**
Hazır mobilya seri üretim olduğu için ölçü esnekliği yoktur; standart dairelere uyar, butik mekânlara uymaz. Siteler'in özel üretim üreticileri sizin daireniz için cm bazında çalışır.

**Siteler'de teslim süresi ne kadar?**
Gerçek üretici 4–7 hafta. 2 haftada teslim sözü veren genelde stok ürün satıyor demektir, "kişiye özel" değildir.

**Siteler'de güvenli ödeme nasıl olur?**
Kapora %30, montaj sonrası kalan ödeme. Tamamı peşin isteyen üreticiyi tercih etmeyin.
