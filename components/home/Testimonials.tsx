            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <p className="font-semibold text-wood-dark">{TESTIMONIALS[current].name}</p>
                    <p className="text-wood-medium/70 text-sm">{TESTIMONIALS[current].location}</p>
                    <p className="text-gold/70 text-xs mt-0.5">{TESTIMONIALS[current].service}</p>
                  </div>
            ...
            <div className="flex gap-2">
              {TESTIMONIALS.map((_, i) => (
                <button
                  ...
                  className={`transition-all ${i === current ? 'w-6 h-2 bg-gold rounded-full' : 'w-2 h-2 bg-wood-medium/30 rounded-full hover:bg-gold/50'}`}
